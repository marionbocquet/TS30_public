...
import plots_maps_trends_MC as pmtmc
from mpl_toolkits.basemap import Basemap

def plot_map_no_cbar(data, fact, vmin, vmax, ccolor):
    MAP_PARAM_DESC = {
        "projection": "laea",
        "lat_ts": 0.,
        "lon_0": 0,
    ...
    mapframe.drawcoastlines(color='gray', linewidth=0.3)
...
ds_ers1 = pd.read_csv('aspect_ASPeCT_ers1rSH_corr_interp_sd_climato_AMSR-AMSR2.csv')
ds_ers2 = pd.read_csv('aspect_ASPeCT_ers2rSH_corr_interp_sd_climato_AMSR-AMSR2.csv')
ds_env3 = pd.read_csv('aspect_ASPeCT_env3SH_corr_interp_sd_climato_AMSR-AMSR2.csv')
ds_c2 = pd.read_csv('aspect_ASPeCT_c2esaDSH1_SARpIN_interp_sd_climato_AMSR-AMSR2.csv')

map_c2 = xr.open_dataset('aspect_ASPeCT_sit_c2esaDSH1_SARpIN_interp_sit_sd_climato_AMSR-AMSR2_snow_depth.nc')
map_ers2 = xr.open_dataset('aspect_ASPeCT_sit_ers2rSH_corr_interp_sit_sd_climato_AMSR-AMSR2_snow_depth.nc')
map_ers1 = xr.open_dataset('aspect_ASPeCT_sit_ers1rSH_corr_interp_sit_sd_climato_AMSR-AMSR2_snow_depth.nc')
map_env3 = xr.open_dataset('aspect_ASPeCT_sit_env3SH_corr_interp_sit_sd_climato_AMSR-AMSR2_snow_depth.nc')
...
plot_map_no_cbar(map_c2['__xarray_dataarray_variable__'].values[1]-map_c2['__xarray_dataarray_variable__'].values[0], -1, -1.2, 1.2, 'cmc.vik')
...
plt.subplot(223)
plot_map_no_cbar(map_env3['__xarray_dataarray_variable__'].values[1]-map_env3['__xarray_dataarray_variable__'].values[0], -1, -1.2, 1.2, 'cmc.vik')
...
plt.subplot(222)
plot_map_no_cbar(map_ers2['__xarray_dataarray_variable__'].values[1]-map_ers2['__xarray_dataarray_variable__'].values[0], -1, -1.2, 1.2, 'cmc.vik')
...
plt.subplot(221)
im = plot_map_no_cbar(map_ers1['__xarray_dataarray_variable__'].values[1]-map_ers1['__xarray_dataarray_variable__'].values[0], -1, -1.2, 1.2, 'cmc.vik')
